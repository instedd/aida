defmodule Aida.HumanOverrideTest do
  ...
  describe "notifications" do
    ...
    test "respond with in_hours_response and push the notification", context do
      [
        # monday in first time slot
        "2018-07-23T14:00:00-03:00",
        # monday in second time slot - without explicit end
        "2018-07-23T20:01:00-03:00",
        # tuesday's time slot with implicit start
        "2018-07-24T02:50:00-03:00",
        # wednesday all day
        "2018-07-25T02:50:00-03:00",
        # wednesday all day
        "2018-07-25T10:50:00-03:00",
        # wednesday all day
        "2018-07-25T23:50:00-03:00",
        # still wednesday, but in a different timezone
        "2018-07-26T02:50:00Z"
      ]
    ...
    test "respond with off_hours_response and push the notification", context do
      [
        # monday before first time slot
        "2018-07-23T09:12:00-03:00",
        # monday between time slots
        "2018-07-23T19:00:00-03:00",
        # tuesday after end time
        "2018-07-24T03:05:00-03:00",
        # no slots on thursday
        "2018-07-26T02:50:00-03:00",
        # no slots on thursday
        "2018-07-26T10:50:00-03:00",
        # no slots on thursday
        "2018-07-26T23:50:00-03:00",
        # already thursday in our timezone
        "2018-07-25T23:50:00-06:00"
      ]
